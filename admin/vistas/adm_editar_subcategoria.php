...
<div class="container mt-5">
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form action="accion/acc_editar_subcategoria.php?id=<?= $subcategoria->getId(); ?>" method="post">
                <div class="mb-3">
                    <label for="nombre" class="form-label">Nombre</label>
                    <input type="text" class="form-control" id="nombre" name="nombre"
                           value="<?= $subcategoria->getNombre(); ?>">
                </div>
                <div class="mb-3">
                    <label for="descripcion" class="form-label">Descripción</label>
                    <input type="text" class="form-control" id="descripcion" name="descripcion"
                           value="<?= $subcategoria->getDescripcion(); ?>">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="es_menu" id="esMenuSi"
                                   value="1" <?= $subcategoria->getEsmenu() ? 'checked' : ''; ?>>
                            <label class="form-check-label" for="esMenuSi">Sí</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="es_menu" id="esMenuNo"
                                   value="0" <?= !$subcategoria->getEsmenu() ? 'checked' : ''; ?>>
