...
(
  ...
  comment 'tabla que contiene la categoria de productos' collate = utf8mb4_general_ci;
...
(
  ...
  comment 'tabla con la distinta informacion de materiales y medidas' collate = utf8mb4_general_ci;
...
(
  ...
  producto_oferta_id   int        default 0           null,
...
(
  ...
  comment 'permite ingresar multiples productos a un carrito de usuario' collate = utf8mb4_general_ci;
...
(
  ...
  comment 'genera la relacion de varios productos con varias categorias' collate = utf8mb4_general_ci;
...
(
  ...
  comment 'representa una subcategoria desgranando mejor las categorias padre' collate = utf8mb4_general_ci;
...
(
  ...
  comment 'contiene la base de clientes registrados' collate = utf8mb4_general_ci;
