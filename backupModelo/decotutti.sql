...
--
-- Servidor: localhost
-- Tiempo de generación: 20-12-2023 a las 22:54:11
...
(11, 'descuento sobre la segunda unidad', '2x1', 16),
(13, 'asd', 'SuperOferta!', 1);
...
(5, 'Florero Abill', 150000, 'Centrándose en las sutilezas de las formas, nuestro florero Abill está elaborado en vidrio en color blanco opaco. Esta pieza original y sofisticada está pensada para la exhibición de flores o como adorno decorativo en mesas bajas y consolas de espacios modernos. Conoce toda nuestra línea de floreros.', '1700677253.webp', 10, 1, 1, 1, '2023-11-22 00:00:00', 1, NULL, NULL),
...
(15, 'Canvas Crown', 10500, 'Esta impresión en lienzo es una reproducción de la partitura de Crown Diamonds..', '1700683327.webp', 1, 1, 1, 3, '2023-11-22 00:00:00', 1, NULL, NULL),
...
--
ALTER TABLE `productos`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id de tabla', AUTO_INCREMENT=35;
